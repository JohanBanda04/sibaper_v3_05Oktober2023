...
<section class="content">
    ...
    <div class="row">
        ...
        $query_jml_permintaan_old = mysqli_query($koneksi, "select count(*) as jml_permintaan from sementara where id_subbidang=$_SESSION[subbidang_id] and status_acc='Pengajuan Kasub'");
        $query_jml_permintaan = mysqli_query($koneksi, "select count(*) as jml_permintaan from sementara 
where status_acc='Pengajuan Kasub Bendahara'");
        ?>
...
<!--                <a href="index.php?p=datapermintaan" class="small-box-footer">Info Lebih Lanjut <i class="fa fa-arrow-circle-right"></i></a>-->
        ...
        <div class="col-lg-4 col-xs-12">
            ...
            <div class="small-box bg-green" style="border-radius: 25px">
                ...
                <a href="index.php?p=history_kasub_operator_table&pa=history_kasub_operator" class="small-box-footer" style="border-bottom-left-radius: 25px; border-bottom-right-radius: 25px; ">Info Lebih Lanjut <i
